...
export const experiences = [
  {
    ...
    description: "Southside Festival is a vibrant celebration of art, nature, and self-expression. From hands-on workshops to live music and games, every moment invites you to unwind, create, and celebrate the joy of expression. Ticket Types: 🌿 Early Bird (₦5,000) – Limited discount for the fastest hands. 🌱 Entry Token (₦8,000) – Basic access + starter tokens. 🎨 Experience Pass (₦20,000) – More tokens to dive into pottery, tie & dye, painting etc.",
    date: "December 2025",
    time: "Check schedule",
    location: "Ekondo Park Abuja",
    price: 5000, // Price range: ₦5,000 - ₦20,000 (Early Bird to Experience Pass)
    capacity: 200,
    spotsLeft: 150,
    type: "Event",
    image: "/images/ekondo december event.jpeg",
    featured: true,
  },
  {
    id: 1,
