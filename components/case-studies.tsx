...
export default function CaseStudies() {
  // Static list from public/images/Services Casestudy
   const items: CaseStudy[] = useMemo(
     () => [
       { client: "Arami", images: [
        "/images/Services Casestudy/arami1.webp", 
        "/images/Services Casestudy/Arami2.webp",
        "/images/Services Casestudy/Arami3.webp",
      ] },
       { client: "Ceesolar", images: [
        "/images/Services Casestudy/Ceesolar1.webp",
        "/images/Services Casestudy/Ceesolar2.webp",
        "/images/Services Casestudy/Ceesolar3.webp",
      ] },
       { client: "French Institute", images: [
        "/images/Services Casestudy/French Institute1.webp",
        "/images/Services Casestudy/French Institute2.webp",
        "/images/Services Casestudy/French Institute3.webp",
        "/images/Services Casestudy/French Institute4.webp",
        "/images/Services Casestudy/French Institute5.webp",
      ] },
       { client: "Napims", images: [
        "/images/Services Casestudy/Napims1.webp",
        "/images/Services Casestudy/Napims2.webp",
        "/images/Services Casestudy/Napims3.webp",
        "/images/Services Casestudy/Napims4.webp",
      ] },
       { client: "NNPC RTI HQ", images: [
        "/images/Services Casestudy/NNPC1.webp",
        "/images/Services Casestudy/NNPC2.webp",
        "/images/Services Casestudy/NNPC3.webp",
      ] },
       { client: "Tele Softas", images: [
        "/images/Services Casestudy/tele softas1.webp",
        "/images/Services Casestudy/tele softas2.webp",
        "/images/Services Casestudy/tele softas3.webp",
      ] },
       { client: "UAC High-Res", images: [
        "/images/Services Casestudy/UAC1.webp",
        "/images/Services Casestudy/UAC2.webp",
        "/images/Services Casestudy/UAC3.webp",
      ] },
       { client: "Urban Abode Estate Abuja", images: [
        "/images/Services Casestudy/Urban Abode1.webp",
        "/images/Services Casestudy/Urban Abode2.webp",
        "/images/Services Casestudy/Urban Abode3.webp",
      ] },
     ],
     []
   )
